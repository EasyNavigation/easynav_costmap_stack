...
#ifndef EASYNAV_COSTMAP_CONTROLLER__SERESTCONTROLLER_HPP_
#define EASYNAV_COSTMAP_CONTROLLER__SERESTCONTROLLER_HPP_
...
/**
 * @brief SeReST (Safe Reparameterized Time) controller for path tracking on costmaps.
 *
...
private:
   ...
   * Otherwise, it is estimated from the costmap in a local window around the robot.
   *
   * @param nav_state Blackboard accessor.
   * @param map Dynamic costmap.
   * @param robot_xy Robot position in world coordinates.
  ...
  /// @brief Lethal cost threshold on the costmap.
...
#endif  // EASYNAV_COSTMAP_CONTROLLER__SERESTCONTROLLER_HPP_
